    ...
    <div class="row">
        ...
        <div class="col-sm-4 p-2">
            <div <?php echo clickOpen( 'gateway/list/'.$category->id ); ?> class="clicable card bg-dark text-white p-0 z-depth-3">
                <img class="card-img" src="<?php echo e(( $category->belongsTo( 'midia' ) ) ? 
        ...
        <div class="col-sm-4 p-2">
            <div <?php echo clickOpen( 'gateway/list/1' ); ?> class="clicable card bg-dark text-white p-0 z-depth-3">
                <img class="card-img" src="<?php echo e(base_url( 'public/images/categoria_geral.png' )); ?>" alt="Card image">
                <div class="card-img-overlay p-0">
                    <h5 class="card-title bg-success position-absolute p-2 z-depth-3"
