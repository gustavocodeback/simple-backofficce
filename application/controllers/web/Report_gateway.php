...
class Report_gateway extends SG_Controller {
	...
	public function __construct() {
		...
		// Seta o contexto
		sidebar( 'Veículos denunciados' );

		// Carrega a model
		$this->load->model( 'report_gateway' );
		$this->model = $this->Report_gateway;
		...
		setItem( 'url', 'report_gateway/datatables' );
	...
	public function delete( $id = false ) {
		...
		// carrega a view
		close_page( 'report_gateway/list' );
	}
}
