 ...
 * Customer_notice
 * 
 * Controller de crud para Customer_notice
 * 
 */
class Customer_notice extends SG_Controller {
	...
	public function __construct() {
		...
		// Seta o contexto
		context( 'customer_notice' );

		// carrega a model
		$this->load->model( 'customer_notice' );
		$this->model = $this->Customer_notice;
		...
		setItem( 'url', 'customer_notice/datatables' );
  ...
  array (
	...
	public function delete( $id = false ) {
		...
		// carrega a view
		close_page( 'customer_notice/list' );
	}
