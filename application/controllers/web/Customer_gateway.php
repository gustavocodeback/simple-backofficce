 ...
 * Customer_gateway
 * 
 * Controller de crud para Customer_gateway
 * 
 */
class Customer_gateway extends SG_Controller {
	...
	public function __construct() {
		...
		// Seta o contexto
		context( 'customer_gateway' );

		// carrega a model
		$this->load->model( 'customer_gateway' );
		$this->model = $this->Customer_gateway;
		...
		setItem( 'url', 'customer_gateway/datatables' );
  ...
  array (
	...
	public function delete( $id = false ) {
		...
		// carrega a view
		close_page( 'customer_gateway/list' );
	}
