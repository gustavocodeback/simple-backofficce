 ...
 * User_group
 * 
 * Controller de crud para User_group
 * 
 */
class User_group extends SG_Controller {
	...
	public function __construct() {
		...
		setItem( 'url', 'user_group/datatables' );
